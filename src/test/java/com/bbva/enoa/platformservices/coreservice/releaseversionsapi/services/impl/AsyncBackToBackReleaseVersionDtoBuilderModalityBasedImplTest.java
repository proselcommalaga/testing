...
class AsyncBackToBackReleaseVersionDtoBuilderModalityBasedImplTest
{

    @InjectMocks
    private AsyncBackToBackReleaseVersionDtoBuilderModalityBasedImpl releaseVersionDtoBuilderModalityBased;
    ...
    {
        @Test
        void buildRVApiDTOConsumed()
        {
            // given
            AsyncBackToBackApiImplementation apiImplementation = Mockito.mock(AsyncBackToBackApiImplementation.class);
            AsyncBackToBackApiVersion asyncBackToBackApiVersion = Mockito.mock(AsyncBackToBackApiVersion.class);
            AsyncBackToBackApi asyncBackToBackApi = Mockito.mock(AsyncBackToBackApi.class);
    ...
    {
        // given
        ApiModality apiModality = ApiModality.ASYNC_BACKTOBACK;
