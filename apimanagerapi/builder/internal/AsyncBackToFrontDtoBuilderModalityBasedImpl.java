...
@Component
@AllArgsConstructor
public class AsyncBackToFrontDtoBuilderModalityBasedImpl implements IDtoBuilderModalityBased<AsyncBackToFrontApi, AsyncBackToFrontApiVersion, AsyncBackToFrontApiImplementation>
{
    ...
    @Override
    public ApiDetailDto buildApiDetailDto(final AsyncBackToFrontApi api)
    {
    ...
    private ApiVersionDto[] buildApiVersionDtoArrayFromApiVersionList(List<AsyncBackToFrontApiVersion> apiVersionList)
    {
    ...
    @Override
    public ApiPlanDto buildApiPlanDto(final AsyncBackToFrontApiVersion apiVersion, final String releaseName, final PlanProfile planProfile)
    {
    ...
    private Integer getPendingTaskForApi(final AsyncBackToFrontApi syncApi)
    {
